...
const Homepage = () => {
    ...
    return (
        <section
            id="homepage"
            className="border border-neutral-200 dark:border-neutral-800 min-h-[80vh] sm:min-h-[87vh] box-border dark:bg-neutral-900 bg-neutral-50 w-[90%] 2xl:w-4/5 xl:w-5/6 m-auto mt-24 sm:p-8 rounded-lg shadow-sm">
            <div className="box-border h-[80vh] grid grid-cols-1 sm:grid-cols-2 justify-around items-center ">
                <div className="w-[85%] box-border sm:w-3/6 inline-block m-auto">
                    ...
                    <h1 className="text-6xl sm:text-[11rem] box-border w-min text-center sm:text-left   dark:bg-neutral-600  dark:text-slate-200 leading-relaxed">
                        Shantanu!
                    </h1>
                </div>
