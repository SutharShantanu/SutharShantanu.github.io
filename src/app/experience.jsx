        ...
        <section
            ...
            <div className="m-8">
                <ol class="relative border-s border-neutral-200 dark:border-neutral-700">
                    ...
                    <li class="mb-10 ms-8 border border-neutral-200 p-4 rounded-lg group">
                        <span class="absolute flex items-center justify-center w-8 h-8 bg-green-100 rounded-full -start-4 ring-8 ring-white dark:ring-neutral-900 dark:bg-blue-900 ">
                            <svg
