    ...
    <div className="projects-projects" id="projects">
      ...
      <div className="projects-container">
        ...
        <div className="project-card">
          <div className="project-card-container">
            <div className="project-img">
              <img src={process.env.PUBLIC_URL + "./Images/paperfury.png"} alt="" />
            </div>
            <div className="project-card-text">
              <h1 className="project-title">Paperfury</h1>
              <p className="project-description">Paperfury is a retailer of technology products, services and solutions. We work every day to bring you the best technology possible with the goal of making life simpler, easier and better for everyone who uses technology.</p>
              ...
              <div className="project-card-btn">
                <div
                  onClick={() => openLink(`https://github.com/SutharShantanu/-available-blood-5696`)}
                  className="project-github-link"
                >
                  GitHub <FaGithub />
                </div>
                <div
                  onClick={() => openLink(`https://paperfury.netlify.app/`)}
        ...
        <div className="project-card">
          <div className="project-card-container">
            <div className="project-img">
              <img src={process.env.PUBLIC_URL + "./Images/zee-flix.png"} alt="" />
            </div>
            <div className="project-card-text">
              <h1 className="project-title">Zee Flix</h1>
              <p className="project-description">Zee Flix is a retailer of technology products, services and solutions. We work every day to bring you the best technology possible with the goal of making life simpler, easier and better for everyone who uses technology.</p>
              <div className="project-tech-stack">
                <div key={Date.now() + Math.random()}
                  className="project-skills-card">
                  <img
              ...
              <div className="project-card-btn">
                <div
                  onClick={() => openLink(`https://github.com/SutharShantanu/-fit-hook-8952`)}
                  className="project-github-link"
                >
                  GitHub <FaGithub />
                </div>
                <div
                  onClick={() => openLink(`https://zee-flix.netlify.app/`)}
                  className="project-deployed-link"
                >
                  Deploy <HiExternalLink />
                </div>
        ...
        <div className="project-card">
          <div className="project-card-container">
            ...
            <div className="project-card-text">
              ...
              <div className="project-card-btn">
                <div
                  onClick={() => openLink(`https://github.com/SutharShantanu/-absurd-stage-2740`)}
                  className="project-github-link"
                >
                  GitHub <FaGithub />
                </div>
        ...
        <div className="project-card">
          <div className="project-card-container">
            ...
            <div className="project-card-text">
              ...
              <p className="project-description">Todo App is a retailer of technology products, services and solutions. We work every day to bring you the best technology possible with the goal of making life simpler, easier and better for everyone who uses technology.</p>
              <div className="project-tech-stack">
                <div key={Date.now() + Math.random()}
                  className="project-skills-card">
                  <img
              ...
              <div className="project-card-btn">
                ...
                <div
                  onClick={() => openLink(`https://masai-todo-app.netlify.app/`)}
                  className="project-deployed-link"
                >
                  Deploy <HiExternalLink />
                </div>
