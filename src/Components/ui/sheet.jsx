        ...
        <SheetPortal>
            ...
            <SheetPrimitive.Content
                ...
                <SheetPrimitive.Close className="absolute right-1 top-2 rounded-sm transition-opacity hover:opacity-100 focus:outline-none disabled:pointer-events-none">
                    <X className="h-8 w-8 border border-neutral-200 dark:border-neutral-700 bg-neutral-100 hover:bg-neutral-200  dark:bg-neutral-800 dark:hover:bg-neutral-700  shadow-sm rounded-full p-1" />
